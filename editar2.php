...
<section class="login-block">
	...
	<div class="row">
		<div class="col-xs-10 col-sm-10 col-md-6 login-sec">
                    ...
                    <form class="login-form" action="salvar_edicao2.php" method="post">
  <div class="form-group">
	  ...
	  <label for="exampleInputEmail1" class="text-uppercase">CPF ou Numero do Telefone:</label>
      <input type="text" class="form-control" name="cpf2" value="<?php echo $array['cpf']?>" required /><br>
    ...
    <a href="homeloja.php" class="btn btn-login float-right">Cancelar</a>
  </div>
