...
if($logarray == $cpf2){
    ...
    if($insert){
		echo"<script language='javascript' type='text/javascript'>alert('Pontuação computada com Sucesso!');</script>";
$msg = <<<HTML
       <html>
<head>
            ...
            <table cellpadding="0" cellspacing="0" width="600" class="w320">
              <tr>
                <td align="left" class="mobile-padding" style="padding:20px">
                  ...
                  <h2>Você acaba de Pontuar</h2><br>
                  Olá $nome,<br>
...
if (!empty($error)) echo $error; 
	...
	echo"<script language='javascript' type='text/javascript'>alert('Erro ao pontuar, tente novamente');window.location.href='homeloja.php'</script>";	
	}
?>